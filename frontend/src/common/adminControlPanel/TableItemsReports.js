...
import {getAllItemsForAdmin, getAllItemsWithReports} from "../../util/APIUtils";
...
class TableItemsReports extends Component{
    constructor(props) {
        super(props);
        this.state = {
            items: [],
    ...
    loadAllItems(page = 0, size = USER_LIST_SIZE) {
        let promise;
        promise = getAllItemsWithReports(page, size);
...
export default TableItemsReports;